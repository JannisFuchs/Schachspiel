...
class PawnTest
{
    ...
    void capture() throws Move.IllegalMoveException
    {
        ...
        Field calculatedStartField = move.piece.calculateStartField(possibleFields, move, board);
        Assertions.assertEquals(new Field(4, 4), calculatedStartField);
    }
    ...
    void move2Squares() throws Move.IllegalMoveException
    {
        ...
        Field calculatedStartField = move.piece.calculateStartField(possibleFields, move, board);
        Assertions.assertEquals(new Field(6, 4), calculatedStartField);
    }
    ...
    void moveOneSquare() throws Move.IllegalMoveException
    {
        ...
        possibleFields.add(new Field(6, 2));
        Field calculatedStartField = move.piece.calculateStartField(possibleFields, move, board);
        Assertions.assertEquals(new Field(5, 4), calculatedStartField);
    }
